...
kbayesiana  <-  paste0("linea_de_muerte_06.RDATA" )
...
fwrite( entrega[ ,  c("numero_de_cliente", "estimulo"), with=FALSE], sep=",",  file="lgb_bo_conFE_historicas_4000.csv")

entrega[  ,  estimulo :=  c(rep(1, 5000),rep(0,nrow(entrega)-5000))]
fwrite( entrega[ ,  c("numero_de_cliente", "estimulo"), with=FALSE], sep=",",  file="lgb_bo_conFE_historicas_5000.csv")

entrega[  ,  estimulo :=  c(rep(1, 5500),rep(0,nrow(entrega)-5500))]
fwrite( entrega[ ,  c("numero_de_cliente", "estimulo"), with=FALSE], sep=",",  file="lgb_bo_conFE_historicas_5500.csv")

entrega[  ,  estimulo :=  c(rep(1, 6000),rep(0,nrow(entrega)-6000))]
fwrite( entrega[ ,  c("numero_de_cliente", "estimulo"), with=FALSE], sep=",",  file="lgb_bo_conFE_historicas_6000.csv")

entrega[  ,  estimulo :=  c(rep(1, 6500),rep(0,nrow(entrega)-6500))]
fwrite( entrega[ ,  c("numero_de_cliente", "estimulo"), with=FALSE], sep=",",  file="lgb_bo_conFE_historicas_6500.csv")

entrega[  ,  estimulo :=  c(rep(1, 7000),rep(0,nrow(entrega)-7000))]
fwrite( entrega[ ,  c("numero_de_cliente", "estimulo"), with=FALSE], sep=",",  file="lgb_bo_conFE_historicas_7000.csv")

entrega[  ,  estimulo :=  c(rep(1, 8000),rep(0,nrow(entrega)-8000))]
fwrite( entrega[ ,  c("numero_de_cliente", "estimulo"), with=FALSE], sep=",",  file="lgb_bo_conFE_historicas_8000.csv")

lgb.save(modelo_final, "modelo_borradorDL_BO_conFE_conHistoria.txt")
